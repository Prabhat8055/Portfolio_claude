    ...
    >
      ...
      >
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          ...
          {/* Project number */}
          <div
            className="absolute top-4 left-5 text-6xl font-black opacity-5"
        ...
        {project.featured && (
          <div
            className="absolute top-3 right-3 flex items-center gap-1 px-2 py-1 rounded-full glass text-xs font-mono"
            style={{
              border: "1px solid var(--border)",
              color: "var(--accent)",
              fontFamily: "DM Mono",
        ...
        {/* Year */}
        <div
          className="absolute bottom-3 left-5 text-xs font-mono"
...
export default function Projects() {
  return (
    ...
    >
      ...
      {/* Decorative blob */}
      <div
        className="absolute left-0 top-1/2 -translate-y-1/2 w-80 h-80 rounded-full blur-3xl opacity-10 blob"
